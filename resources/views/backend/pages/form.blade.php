...
<?php
    $templateBodybodyClasses = 'edit-pages';
?>
                          ...
                          !!}
                            ...
                            <div class="box-body">
                              <div class="form-group">
                                <label for="title" class="col-sm-2 control-label">{!! Form::label(Lang::get('backend.pages.createtitle')) !!}</label>
                              ...
                              <div class="form-group">
                                <label for="pagesidebar" class="col-sm-2 control-label">Sidebar Content</label>

                                <div class="col-sm-10">
                                  {!! Form::textarea('pagesidebar', null, ['class'=>'form-control', 'id' => 'pagesidebar']) !!}
                                </div>
                              </div>
                            </div>
                            <!-- /.box-body -->
                            <div class="box-footer">
                              ...
                              {!! Form::button(''.Lang::get('back/admin.save').'', array('class'=>'btn btn-info pull-right', 'type'=>'submit')) !!}
                            </div>
                            <!-- /.box-footer -->
                          {!! Form::close() !!}
                        </div>
...
@section('template_scripts')
    ...
    {!! HTML::script('/vendor/unisharp/laravel-ckeditor/ckeditor.js', array('type' => 'text/javascript')) !!}
    ...
    <script>
      $(function(){
        ...
        CKEDITOR.replace('pagesidebar');
        $("#pagesummary").wysihtml5();
      });
    </script>
